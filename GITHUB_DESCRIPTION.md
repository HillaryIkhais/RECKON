...
RECKON is an agent that demonstrates a core principle: AI agents should not receive permission to perform consequential actions simply because they are confident.
...
- MCP server registered in TrueForge
